          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center space-y-4">
              <h1 className="text-4xl font-bold tracking-tight text-primary sm:text-6xl">
                NovaChat <span className="text-blue-600">AI</span>
              </h1>
              <p className="font-medium text-muted-foreground max-w-lg mx-auto text-lg">
                Intelligent document intelligence. Upload your PDFs and start a meaningful conversation with your data.
              </p>
              <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground">
                <span className="px-2 py-1 bg-secondary rounded-full">Secure</span>
                <span className="px-2 py-1 bg-secondary rounded-full">Private</span>
                <span className="px-2 py-1 bg-secondary rounded-full">AI-Powered</span>
              </div>
            </div>
          </div>
